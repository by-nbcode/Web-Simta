...
// data Mahasiswa
$id_mhs = $_GET['id'];
$mhs  = tampilData("SELECT * FROM tb_mahasiswa JOIN tb_user ON tb_mahasiswa.id_user = tb_user.id_user WHERE id_mhs = $id_mhs ")[0];
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Edit & Update data Mahasiswa</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg">
                                ...
                                <?php if (isset($suksess)) : ?>
                                    <div class="alert alert-success border-0 alert-dismissible fade show" role="alert">
                                        <strong> Data mahasiswa berhasil diubah !</strong>
                                ...
                                <?php if (isset($error)) : ?>
                                    <div class="alert alert-danger border-0 alert-dismissible fade show" role="alert">
                                        <strong> Data mahasiswa gagal diubah !</strong>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nim" class="form-control font-weight-bold" value="<?= $mhs['nim'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="nama" class="col-sm-3 col-form-label">Nama</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nama_mhs" class="form-control font-weight-bold" id="nama" value="<?= $mhs['nama_mhs'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="jk" class="col-sm-3 col-form-label">Jenis Kelamin</label>
                                                    <div class="col-sm-9">
                                                        <select name="jk" id="jk" class="form-control text-dark font-weight-bold">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="prodi" id="prodi" class="form-control text-dark font-weight-bold">
                                                            <option value=""> pilih </option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="status" id="status" class="form-control text-dark font-weight-bold">
                                                            <option value=""> pilih </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control text-dark font-weight-bold" id="angakatan" name="angkatan" value="<?= $mhs['angkatan'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="agama" class="col-sm-3 col-form-label">Agama</label>
                                                    <div class="col-sm-9">
                                                        <select name="agama" id="agama" class="form-control font-weight-bold text-dark">
                                                            <option value=""> pilih </option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="email" class="form-control text-dark font-weight-bold" id="email" value="<?= $mhs['email'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="prodi" class="col-sm-3 col-form-label">Username</label>
                                                    <div class="col-sm-9">
                                                        <select name="id_user" id="id_user" class="form-control text-dark font-weight-bold" required>
                                                            <option value=""> pilih </option>
                                                            <?php foreach ($data_user as $user) : ?>
                                                                <option value="<?= $user['id_user'] ?>" <?= ($mhs['id_user'] == $user['id_user']) ? 'selected' : '' ?>>
                                                                    <?= $user['username'] ?>
                                                                </option>
                                                            <?php endforeach ?>
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg text-right">
                                                        ...
                                                        <button type="submit" name="ubah" class="btn btn-success mr-2">Update & Simpan</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
